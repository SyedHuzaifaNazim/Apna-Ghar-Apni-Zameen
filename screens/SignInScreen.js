...
export default function SignInScreen() {
  ...
  const handleSignIn = async () => {
    try {
      ...
      if (data.status === 'ok') {
        login(data.user); // Save user to global context
        navigation.navigate('Profile'); // Go back to profile (now logged in)
      } else {
...
// Reuse styles from SignUpScreen or create shared styles
