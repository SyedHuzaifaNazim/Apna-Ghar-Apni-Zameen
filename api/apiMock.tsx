export interface Property {
    ...
    propertyCategory: 'Residential Flat' | 'Commercial Shop' | 'Industrial Plot' | 'Residential House' | 'Commercial Office';
    price: number;
    currency: string;
    areaSize: number;
    address: {
  ...
  export const MOCK_PROPERTIES: Property[] = [
    {
      id: 1001,
      title: "Luxury 3-Bed Apartment near DHA Phase 5",
      ...
      address: {
        city: "Karachi",
        line1: "DHA Phase 5, Street 12",
        latitude: 24.8607,
        longitude: 67.0011
      },
      bedrooms: 3,
      description: "Beautiful luxury apartment with modern amenities, spacious rooms, and premium finishes. Located in prime DHA area with 24/7 security and all utilities available.",
      datePosted: "2024-10-25T10:00:00Z",
      isFeatured: true,
      images: [
    ...
    {
      id: 1002,
      title: "Commercial Shop in Bahadurabad Main Market",
      ...
      address: {
        city: "Karachi",
        line1: "Bahadurabad Main Market, Shop No. 45",
        latitude: 24.8910,
        longitude: 67.0489
      },
      bedrooms: 0,
      description: "Prime location commercial shop in busy Bahadurabad market. High foot traffic, excellent for retail business. Recently renovated with modern facilities.",
      datePosted: "2024-10-24T14:30:00Z",
      isFeatured: true,
      images: [
    ...
    {
      id: 1003,
      title: "Industrial Plot in Korangi Industrial Area",
      listingType: "For Sale",
      ...
      address: {
        city: "Karachi",
        line1: "Korangi Industrial Area, Sector 7",
        latitude: 24.8125,
        longitude: 67.1180
      },
      bedrooms: 0,
      description: "Large industrial plot in established industrial zone. All utilities available including gas, electricity, and water. Perfect for manufacturing unit.",
      datePosted: "2024-10-23T09:15:00Z",
      isFeatured: false,
      images: [
    ...
    {
      id: 1004,
      title: "Modern 2-Bed Flat in Clifton",
      listingType: "For Rent",
      propertyCategory: "Residential Flat",
      price: 45000,
      currency: "PKR",
      ...
      address: {
        city: "Karachi",
        line1: "Clifton Block 2, Sea View Road",
        latitude: 24.8170,
        longitude: 67.0317
      },
      bedrooms: 2,
      description: "Fully furnished modern apartment with sea view. Includes all appliances, covered parking, and 24/7 security. Walking distance to restaurants and cafes.",
      datePosted: "2024-10-22T16:45:00Z",
      isFeatured: true,
      images: [
    ...
    {
      id: 1005,
      title: "Commercial Office Space in I.I. Chundrigar Road",
      listingType: "For Sale",
      ...
      address: {
        city: "Karachi",
        line1: "I.I. Chundrigar Road, Financial District",
        latitude: 24.8500,
        longitude: 67.0050
      },
      bedrooms: 0,
      description: "Premium office space in Karachi's financial hub. Modern building with elevator, central AC, and high-speed internet. Ideal for corporate offices.",
      datePosted: "2024-10-21T11:20:00Z",
      isFeatured: false,
      images: [
    ...
    {
      id: 1006,
      title: "4-Bed Independent House in Gulshan",
      listingType: "For Sale",
      ...
      address: {
        city: "Karachi",
        line1: "Gulshan-e-Iqbal, Block 13-A",
        latitude: 24.9137,
        longitude: 67.0937
      },
      bedrooms: 4,
      description: "Spacious independent house with large garden and modern amenities. Includes servant quarters, double garage, and premium finishes throughout.",
      datePosted: "2024-10-20T13:10:00Z",
      isFeatured: true,
      images: [
    ...
    {
      id: 1007,
      title: "1-Bed Flat for Students in North Nazimabad",
      listingType: "For Rent",
      propertyCategory: "Residential Flat",
      price: 18000,
      currency: "PKR",
      ...
      address: {
        city: "Karachi",
        line1: "North Nazimabad, Block L",
        latitude: 24.9398,
        longitude: 67.0547
      },
      bedrooms: 1,
      description: "Compact and affordable flat perfect for students. Basic amenities included, near educational institutions and public transport.",
      datePosted: "2024-10-19T08:30:00Z",
      isFeatured: false,
      images: [
    ...
    {
      id: 1008,
      title: "Warehouse Space in SITE Area",
      listingType: "For Rent",
      propertyCategory: "Industrial Plot",
      price: 120000,
      currency: "PKR",
      ...
      address: {
        city: "Karachi",
        line1: "SITE Industrial Area, Super Highway",
        latitude: 24.9500,
        longitude: 67.1500
      },
      bedrooms: 0,
      description: "Large warehouse space with high ceilings and loading docks. Suitable for storage, distribution, or light manufacturing. Security and utilities included.",
      datePosted: "2024-10-18T15:45:00Z",
      isFeatured: false,
      images: [
    ...
    {
      id: 1009,
      title: "Penthouse with Terrace View in Defence",
      listingType: "For Sale",
      propertyCategory: "Residential Flat",
      price: 25000000,
      currency: "PKR",
      ...
      address: {
        city: "Karachi",
        line1: "Defence Housing Authority, Phase 6",
        latitude: 24.8000,
        longitude: 67.0700
      },
      bedrooms: 3,
      description: "Luxurious penthouse with private terrace and panoramic city views. Premium finishes, modern kitchen, and spacious living areas. Exclusive building with amenities.",
      datePosted: "2024-10-17T12:00:00Z",
      isFeatured: true,
      images: [
    ...
    {
      id: 1010,
      title: "Medical Clinic Space in Gulistan-e-Johar",
      listingType: "For Rent",
      propertyCategory: "Commercial Shop",
      price: 55000,
      currency: "PKR",
      ...
      address: {
        city: "Karachi",
        line1: "Gulistan-e-Johar, Block 7",
        latitude: 24.9130,
        longitude: 67.1300
      },
      bedrooms: 0,
      description: "Ideal space for medical clinic or pharmacy. High visibility location with ample parking. Recently renovated with medical-grade electrical and plumbing.",
    ...
    {
      id: 1011,
      title: "2-Bed Flat Near Karachi University",
      listingType: "For Rent",
      propertyCategory: "Residential Flat",
      price: 25000,
      currency: "PKR",
      ...
      address: {
        city: "Karachi",
        line1: "University Road, Near KU Main Gate",
        latitude: 24.9333,
        longitude: 67.1167
      },
      bedrooms: 2,
      description: "Convenient location for university students and faculty. Basic furnishings included, secure building with nearby markets and public transport.",
      datePosted: "2024-10-15T14:20:00Z",
      isFeatured: false,
      images: [
        "https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=800",
        "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=800"
    ...
    {
      id: 1012,
      title: "Commercial Showroom in Tariq Road",
      listingType: "For Sale",
      propertyCategory: "Commercial Shop",
      price: 20000000,
      currency: "PKR",
      ...
      address: {
        city: "Karachi",
        line1: "Tariq Road, Commercial Area",
        latitude: 24.8825,
        longitude: 67.0644
      },
      bedrooms: 0,
      description: "Prime commercial showroom in one of Karachi's busiest shopping districts. High customer traffic, ideal for retail business or showroom.",
      datePosted: "2024-10-14T09:45:00Z",
      isFeatured: true,
      images: [
        "https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=800",
        "https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=800"
    ...
    {
      id: 1013,
      title: "3-Bed Farm House on Super Highway",
      listingType: "For Sale",
      propertyCategory: "Residential House",
      price: 18000000,
      currency: "PKR",
      ...
      address: {
        city: "Karachi",
        line1: "Super Highway, Near Northern Bypass",
        latitude: 24.9800,
        longitude: 67.2000
      },
      bedrooms: 3,
      description: "Peaceful farm house with large outdoor space. Perfect for those seeking quiet living while maintaining city access. Includes garden and parking.",
      datePosted: "2024-10-13T16:15:00Z",
      isFeatured: false,
      images: [
    ...
    {
      id: 1014,
      title: "Office Space in Bahria Town Karachi",
      listingType: "For Rent",
      propertyCategory: "Commercial Office",
      price: 80000,
      currency: "PKR",
      ...
      address: {
        city: "Karachi",
        line1: "Bahria Town, Commercial District",
        latitude: 24.8315,
        longitude: 67.2000
      },
      bedrooms: 0,
      description: "Modern office space in planned community. Includes reception area, meeting rooms, and parking. Perfect for professional services or corporate office.",
      datePosted: "2024-10-12T11:30:00Z",
      isFeatured: false,
      images: [
        "https://images.unsplash.com/photo-1497366754035-f200968a6e72?w=800",
        "https://images.unsplash.com/photo-1497366216548-37526070297c?w=800"
    ...
    {
      id: 1015,
      title: "1-Bed Studio Apartment in Saddar",
      listingType: "For Rent",
      propertyCategory: "Residential Flat",
      price: 15000,
      currency: "PKR",
      ...
      address: {
        city: "Karachi",
        line1: "Saddar, Preedy Street",
        latitude: 24.8600,
        longitude: 67.0300
      },
      bedrooms: 1,
      description: "Compact studio apartment in historic Saddar area. Walking distance to markets, restaurants, and public transport. Basic utilities included.",
      datePosted: "2024-10-11T13:50:00Z",
      isFeatured: false,
      images: [
        "https://images.unsplash.com/photo-1554995207-c18c203602cb?w=800",
        "https://images.unsplash.com/photo-1560185127-6ed189bf02f4?w=800"
    ...
    {
      id: 1016,
      title: "Industrial Land in Nooriabad",
      listingType: "For Sale",
      propertyCategory: "Industrial Plot",
      price: 12000000,
      currency: "PKR",
      ...
      address: {
        city: "Karachi",
        line1: "Nooriabad Industrial Zone",
        latitude: 25.0000,
        longitude: 67.5000
      },
      bedrooms: 0,
      description: "Industrial land in developing industrial zone. All basic utilities available. Perfect for establishing manufacturing facility or warehouse.",
      datePosted: "2024-10-10T10:10:00Z",
      isFeatured: false,
      images: [
        "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=800",
        "https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=800"
    ...
    {
      id: 1017,
      title: "4-Bed Luxury Villa in DHA Phase 8",
      listingType: "For Sale",
      propertyCategory: "Residential House",
      price: 45000000,
      currency: "PKR",
      ...
      address: {
        city: "Karachi",
        line1: "DHA Phase 8, Bukhari Commercial",
        latitude: 24.7900,
        longitude: 67.0600
      },
      bedrooms: 4,
      description: "Stunning luxury villa with swimming pool and landscaped garden. Premium finishes throughout, modern kitchen, and spacious living areas.",
      datePosted: "2024-10-09T15:25:00Z",
      isFeatured: true,
      images: [
        "https://images.unsplash.com/photo-1518780664697-55e3ad937233?w=800",
        "https://images.unsplash.com/photo-1570129477492-45c003edd2be?w=800"
    ...
    {
      id: 1018,
      title: "Restaurant Space in Boat Basin",
      listingType: "For Rent",
      propertyCategory: "Commercial Shop",
      price: 95000,
      currency: "PKR",
      ...
      address: {
        city: "Karachi",
        line1: "Boat Basin, Clifton",
        latitude: 24.8180,
        longitude: 67.0320
      },
      bedrooms: 0,
      description: "Perfect space for restaurant or cafe in popular food street area. Includes kitchen setup and dining area. High customer traffic location.",
      datePosted: "2024-10-08T12:40:00Z",
      isFeatured: false,
      images: [
    ...
    {
      id: 1019,
      title: "2-Bed Flat in PECHS Society",
      listingType: "For Sale",
      propertyCategory: "Residential Flat",
      price: 12000000,
      currency: "PKR",
      ...
      bedrooms: 2,
      description: "Well-maintained flat in established residential society. Close to schools, hospitals, and markets. Secure building with parking facilities.",
      datePosted: "2024-10-07T08:55:00Z",
      isFeatured: false,
      images: [
        "https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=800",
        "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=800"
    ...
    {
      id: 1020,
      title: "Commercial Plaza in Gulshan Main Boulevard",
      listingType: "For Sale",
      propertyCategory: "Commercial Office",
      price: 75000000,
      currency: "PKR",
      ...
      address: {
        city: "Karachi",
        line1: "Gulshan-e-Iqbal, Main Boulevard",
        latitude: 24.9100,
        longitude: 67.0900
      },
      bedrooms: 0,
      description: "Complete commercial plaza with multiple shops and offices. Prime location with high rental yield potential. Recently constructed with modern amenities.",
      datePosted: "2024-10-06T14:05:00Z",
      isFeatured: true,
      images: [
        "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=800",
        "https://images.unsplash.com/photo-1497366754035-f200968a6e72?w=800"
